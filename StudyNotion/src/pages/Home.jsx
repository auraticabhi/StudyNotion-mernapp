...
const Home = () => {
        return ( <
                ...
                <
                div className = 'relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white justify-between' > { /* Become a Instructor Button */ } <
                Link to = { "/signup" } >
                <
                ...
                muted loop autoPlay src = { Banner } > < /video> <
                /div>
                ...
                backgroundGradient = { < div className = "codeblock1 absolute" > < /div>} /
                    ...
                    backgroundGradient = { < div className = "codeblock2 absolute" > < /div>}
                        ...
                        <
                        div className = 'homepage_bg h-[310px]' > { /* Explore Full Catagory Section */ } <
                        ...
                        <
                        div className = "relative mx-auto my-10 max-w-maxContent flex-col items-center justify-between gap-8 bg-richblack-900 text-white" >
